<template>
	<div class="mx-auto max-w-2xl rounded-lg border p-8">
		<div class="prose prose-sm max-w-none">
			<h1 class="text-2xl font-semibold">Welcome to Jirlie Cloud</h1>
			<p>
				Jirlie Cloud makes it easy to manage sites and apps like ERPNext in an
				...
				<div v-if="pendingSiteRequest">
					...
					<div class="mt-2 pl-7" v-if="pendingSiteRequest.status == 'Error'">
						<p class="mt-2 text-p-base text-gray-800">
							Please contact Jirlie Cloud support by clicking on the button
							below.
						</p>
