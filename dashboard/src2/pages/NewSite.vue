		...
		<div v-else-if="options" class="space-y-12 pb-[50vh] pt-12">
			...
			<div v-if="!bench">
				<div class="flex items-center justify-between">
					<h2 class="text-base font-medium leading-6 text-gray-900">
						Select Jirlie Framework Version
					</h2>
				</div>
				<div class="mt-2">
			...
			<div v-if="selectedVersion && cluster">
				<div class="flex items-center justify-between">
					...
					<div>
						<Button link="https://jirlie.com" variant="ghost">
							<template #prefix>
			...
			>
				<FormControl
					...
					:label="`I agree that the laws of the region selected by me (${selectedClusterTitle}) shall stand applicable to me and Jirlie.`"
				/>
				<FormControl
					class="checkbox"
					type="checkbox"
...
export default {
	...
	resources: {
		...
		newSite() {
			...
			this.generatedSubdomain = this.generateSubdomain();
			return {
	...
	computed: {
		...
		siteSummaryOptions() {
			...
			return [
				{
					label: 'Jirlie Framework Version',
				...
				{
					label: 'Jirlie ID',
					value: `${this.generatedSubdomain}` // .${this.options?.domain}
				},
				{
					label: 'Site Plan',
