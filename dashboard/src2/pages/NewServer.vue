		...
		<div v-if="options" class="space-y-12 pb-[50vh] pt-12">
			...
			>
				<FormControl
					...
					:label="`I agree that the laws of the region selected by me shall stand applicable to me and Jirlie.`"
				/>
				<ErrorMessage
					class="my-2"
					:message="
						...
						server_types: [
							{
								...
								description:
									'A pair of dedicated servers managed and owned by Jirlie'
							},
							{
								name: 'hybrid',
								title: 'Hybrid Server',
								description:
									'A pair of dedicated servers managed by Jirlie and owned/provisioned by you'
							}
						],
